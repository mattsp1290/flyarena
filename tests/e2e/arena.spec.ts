...
// WP4 of `.agents/plans/pathway-interventions`'s tested-outcome sentence and
// its own hash-mismatch integrity check live in `./pathway-interventions.spec.ts`
// (split out: this file was already at the thermo-review's 1000-line
// threshold on `origin/main`, and those two self-contained blocks pushed it
// further past it — a maintainability-review suggestion).
