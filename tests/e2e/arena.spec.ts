...
test.describe('model ledger and provenance', () => {
  ...
  test('shows the pathway-intervention tested-outcome sentence under the explanation note, generated from the verified artifact (WP4 of .agents/plans/pathway-interventions)', async ({
    page
  }) => {
    await page.goto('/');
    await waitForReady(page);
    ...
    // not a hardcoded placeholder (mirrors the null-explanation test
    // above's own "assert the real shipped numbers" discipline).
